 ...
 * 1800-19FF and 1A00-1BFF) of the specified Transmit-PDO service conforms to
 * CiA 301.
 *
 ...
 */
int co_tpdo_chk_dev(const co_dev_t *dev, co_unsigned16_t num);
...
/**
 * Creates a new CANopen Transmit-PDO service. The service is stopped after
 * creation and SHOULD be started with co_tpdo_start() before use.
 *
